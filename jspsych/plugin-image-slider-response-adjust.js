        ...
        trial(display_element, trial) {
            ...
            if (trial.render_on_canvas) {
                ...
                img.onload = () => {
                    ...
                    display_element.style.filter = `saturate(${slsVal}%)`;
                    //display_element.style.filter = `contrast(${slsVal}%)`;
                };
            ...
            display_element
                ...
                .addEventListener("mouseup", () => {
                    ...
                    display_element.style.filter = `saturate(${chVal}%)`;
                    //display_element.style.filter = `contrast(${chVal}%)`;
                    ClickNum = ClickNum + 1;
                });
